...
CAPTCHA_NO_DB_WRITE = getattr(settings, 'CAPTCHA_NO_DB_WRITE', False)
CAPTCHA_NO_DB_WRITE_RANDOM_PICK_TIMEOUT = getattr(settings, 'CAPTCHA_NO_DB_WRITE_RANDOM_PICK_TIMEOUT', 5) # Minutes
